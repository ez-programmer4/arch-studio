...
const values = [
  ...
  },
  {
    title: "Quality",
    description:
      "We maintain the highest standards in our work, ensuring exceptional results.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    title: "Transparency",
    description:
      "We believe in open communication and keeping you informed throughout the process.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
          ...
          {values.map((value, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center text-amber-500 group-hover:bg-amber-100 transition-colors duration-300">
                  {value.icon}
                </div>
